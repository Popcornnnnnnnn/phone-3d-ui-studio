...
export interface WorldCommand {type:'world-command';protocolVersion:2;commandId:string;worldId:string;epoch:number;action:WorldAction;settings?:MarbleSettings}
...
export interface WorldSnapshot {
 ...
 region:'tray'|'air'|'needs-ball';geometry:MarbleGeometry;settings?:MarbleSettings;phone:Transform|null;
