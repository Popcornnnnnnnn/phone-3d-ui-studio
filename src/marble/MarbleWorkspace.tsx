...
import { CanvasTexture, Matrix4, MeshStandardMaterial, Quaternion, SRGBColorSpace, Vector3, type Group } from 'three'
...
function clippedMaterial(color: string, inverse: Matrix4) {
  ...
  material.onBeforeCompile = (shader) => {
    ...
    shader.fragmentShader = shader.fragmentShader.replace('#include <clipping_planes_fragment>', `#include <clipping_planes_fragment>
      ...
      if (edgeDistance <= 0.0 && phoneFragment.z >= ${G.screenZ - G.radius} && phoneFragment.z < ${G.screenZ}) discard;`)
  }
  material.customProgramCacheKey = () => 'marble-finite-slot-clip-v2'
  return material
}
